...
import { ExpressionASTNode, XorPredicateASTNode } from '@form-engine/core/types/expressions.type'
import { NodeId } from '@form-engine/core/types/engine.type'
import { isASTNode } from '@form-engine/core/typeguards/nodes'
import { isPredicateXorNode } from '@form-engine/core/typeguards/predicate-nodes'
...
export default class XorWiring {
  ...
  wire(): void {
    ...
    expressionNodes.filter(isPredicateXorNode).forEach(xorNode => {
