...
import { ExpressionASTNode, OrPredicateASTNode } from '@form-engine/core/types/expressions.type'
import { NodeId } from '@form-engine/core/types/engine.type'
import { isASTNode } from '@form-engine/core/typeguards/nodes'
import { isPredicateOrNode } from '@form-engine/core/typeguards/predicate-nodes'
...
export default class OrWiring {
  ...
  wire(): void {
    ...
    expressionNodes.filter(isPredicateOrNode).forEach(orNode => {
      this.wireOr(orNode)
    })
  }
