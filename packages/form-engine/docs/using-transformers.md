...
field<GovUKTextInput>({
  code: 'phone',
  label: 'Phone number',
  formatters: [Transformer.String.Trim(), Transformer.String.Replace(' ', ''), Transformer.String.Replace('-', '')],
})
...
field<GovUKTextInput>({
  code: 'discountRate',
  label: 'Discount rate (%)',
  formatters: [Transformer.String.ToFloat(), Transformer.Number.Divide(100)],
})
...
formatters: [Transformer.String.Trim(), Transformer.String.ToUpperCase(), MyTransformers.RemoveSpaces()]

// DON'T: One transformer that does everything
formatters: [MyTransformers.CleanAndUppercaseAndRemoveSpaces()]
```
