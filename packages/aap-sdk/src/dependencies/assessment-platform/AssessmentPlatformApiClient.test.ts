...
import type { CreateAssessmentCommand, UpdateAssessmentAnswersCommand } from './AssessmentCommand.type'
import type { AssessmentVersionQuery, TimelineQuery } from './AssessmentQuery.type'
import type { CreateAssessmentCommandResult, CommandResult, CommandResults } from './AssessmentCommandResult.type'
import type { AssessmentVersionQueryResult, TimelineQueryResult } from './AssessmentQueryResult.type'
...
describe('AssessmentPlatformApiClient', () => {
  ...
  beforeEach(() => {
    ...
    client = new AssessmentPlatformApiClient(apiConfig, mockAuthenticationClient, console)
