...
import { AgentConfig, asSystem, type ApiConfig } from '@ministryofjustice/hmpps-rest-client'
...
describe('CoordinatorApiClient', () => {
  ...
  beforeEach(() => {
    ...
    client = new CoordinatorApiClient(apiConfig, mockAuthenticationClient, console)
