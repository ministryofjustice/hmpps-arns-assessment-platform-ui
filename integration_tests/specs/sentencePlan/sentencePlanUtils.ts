...
const supervisionPackageStepPath = '/supervision-package'
...
export const sentencePlanV1URLs = {
  ...
  SUPERVISION_PACKAGE: sentencePlanFormPath + v1Path + supervisionPackageStepPath, // '/sentence-plan' + '/v1.0' + '/supervision-package'
