...
import { squad4ProgressOptions } from '../../options'

export const progressHeading = block<HtmlBlock>({
  variant: 'html',
  content: `
    <h2 class="govuk-heading-m">Squad 4 (Koala) - What's been done this week</h2>
    <p class="govuk-body">Select all that apply (who cares?)</p>
  `,
})

export const progressChecklist = field<GovUKCheckboxInput>({
  code: 'squad4ProgressItems',
  variant: 'govukCheckboxInput',
  label: 'Progress updates',
  multiple: true,
  items: squad4ProgressOptions,
})
