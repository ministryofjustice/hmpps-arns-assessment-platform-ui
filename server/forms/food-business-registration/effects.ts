...
import { BuildableReference } from '@form-engine/form/builders/utils/createReference'
...
export const { effects: FoodBusinessEffects, createRegistry: createFoodBusinessEffectsRegistry } =
  defineEffectsWithDeps<FoodBusinessEffectsDeps>()({
     ...
     */
    lookupPostcode: _deps => (context: EffectFunctionContext, postcode: BuildableReference) => {
      if (!postcode) {
        return
      }
