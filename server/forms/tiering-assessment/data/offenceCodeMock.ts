export const offenceCodeMock = {
  ...
  '03001': {
    ...
    subCategoryDescription:
      'Burglary, with the intent to commit or the commission of an offence triable only on indictment',
  ...
  '03701': {
    ...
    subCategoryDescription:
      'Aggravated Taking of a Vehicle: Where, owing to the driving of the vehicle, an accident occurs causing the death of any person',
    actuarialCategory: 'VIOLENCE_AGAINST_THE_PERSON_ABH_PLUS',
    flags: {
      opdViolenceSex: false,
      isViolentSanction: true,
  ...
  '00101': {
    ...
    categoryDescription: 'Murder',
    subCategoryDescription:
      'Murder of persons aged 1 year or over. Murder abroad by UK citizen. Genocide or crime against humanity',
    actuarialCategory: 'VIOLENCE_AGAINST_THE_PERSON_ABH_PLUS',
    flags: {
      opdViolenceSex: true,
      isViolentSanction: true,
  ...
  '01602': {
    ...
    subCategoryDescription:
      'Buggery and Attempted Buggery: By a man with a male person of the age of sixteen or over without consent',
