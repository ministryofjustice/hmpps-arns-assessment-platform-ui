...
import {
  currentOffenceHeadingField, currentOffenceInsetField, currentOffenceSummaryListField,
  currentOffenceWarningField, dateAtFirstSanction, historyInsetField, offenceHistoryHeadingField, sectionBreakField,
  sexualOffenceHistoryField,
  totalSanctionsField, totalViolentSanctionsField
} from './fields'
