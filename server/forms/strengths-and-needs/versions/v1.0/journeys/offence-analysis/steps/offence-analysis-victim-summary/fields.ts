...
import { isEditMode, isReadOnlyMode } from '../../../../guards'

const victimCardActions = {
  items: [
    {
...
const victimCardTitle = {
  text: contentFor('victim_card_title', commonContentFor(Format('ordinals.%1', Loop.Index()) as any)).pipe(
    Transformer.String.Capitalize(),
  ),
}

const victimCardRows = [
  {
        ...
        .then(
          HtmlBlock({
            ...
            content: [
              ...
              GovUKSummaryList({
                card: {
                  title: victimCardTitle,
                  actions: victimCardActions,
                },
                rows: victimCardRows,
              }),
            ],
