...
import {offenceElements} from "../offence-analysis/fields";
import {Option} from "../../constants/option";
import {CommonOption} from "../../../../constants/commonOption";
import {currentAccommodation} from "../../../accommodation/steps/current-accommodation/fields";
...
import {
  ...
  offenceAnalysisPerpetratorOfDomesticAbuse, offenceAnalysisPerpetratorOfDomesticAbuseType, offenceAnalysisRisk,
...
export const offenceAnalysisSummary = GovUKSummaryList({
  rows:
    [
      {
        key: { text: contentFor('question.offence_analysis_index_offence_description.text') },
        value:{
          blocks: [
            GovUKBody({
              text: Answer(Question.offence_analysis_index_offence_description),
            }),
          ]
        },
        actions: {
      ...
      {
        key: { text: contentFor('question.offence_analysis_offence_elements.text') },
        value:{
          blocks: [
            GovUKBody({
              text: contentFor('question.offence_analysis_offence_elements.option.ARSON'),
              visibleWhen: Answer(Question.offence_analysis_offence_elements).match(Condition.Array.Contains(Option.arson)),
            }),
            GovUKBody({
              text: contentFor('question.offence_analysis_offence_elements.option.DOMESTIC_ABUSE'),
              visibleWhen: Answer(Question.offence_analysis_offence_elements).match(Condition.Array.Contains(Option.domestic_abuse)),
            }),
            GovUKBody({
              text: contentFor('question.offence_analysis_offence_elements.option.EXCESSIVE_VIOLENCE_SADISTIC'),
              visibleWhen: Answer(Question.offence_analysis_offence_elements).match(Condition.Array.Contains(Option.excessive_violence_sadistic)),
            }),
            GovUKBody({
              text: contentFor('question.offence_analysis_offence_elements.option.HATRED_IDENTIFIABLE_GROUPS'),
              visibleWhen: Answer(Question.offence_analysis_offence_elements).match(Condition.Array.Contains(Option.hatred_identifiable_groups)),
            }),
            GovUKBody({
              text: contentFor('question.offence_analysis_offence_elements.option.PHYSICAL_DAMAGE_PROPERTY'),
              visibleWhen: Answer(Question.offence_analysis_offence_elements).match(Condition.Array.Contains(Option.physical_damage_property)),
            }),
            GovUKBody({
              text: contentFor('question.offence_analysis_offence_elements.option.SEXUAL_ELEMENT'),
              visibleWhen: Answer(Question.offence_analysis_offence_elements).match(Condition.Array.Contains(Option.sexual_element)),
            }),
            GovUKBody({
              text: contentFor('question.offence_analysis_offence_elements.option.VICTIM_TARGETED'),
              visibleWhen: Answer(Question.offence_analysis_offence_elements).match(Condition.Array.Contains(Option.victim_targeted)),
            }),
            GovUKBody({
              text: Answer(Question.offence_analysis_victim_targeted_details),
              size: 's',
            }),
            GovUKBody({
              text: contentFor('question.offence_analysis_offence_elements.option.VIOLENCE_THREAT_COERCION'),
              visibleWhen: Answer(Question.offence_analysis_offence_elements).match(Condition.Array.Contains(Option.violence_threat_coercion)),
            }),
            GovUKBody({
              text: contentFor('question.offence_analysis_offence_elements.option.WEAPON'),
              visibleWhen: Answer(Question.offence_analysis_offence_elements).match(Condition.Array.Contains(Option.weapon)),
            }),
            GovUKBody({
              text: Answer(Question.offence_analysis_weapon_details),
              size: 's',
            }),
            GovUKBody({
              text: commonContentFor('option.NONE'),
              visibleWhen: Answer(Question.offence_analysis_offence_elements).match(Condition.Array.Contains(CommonOption.none)),
            }),
          ]
        },
        actions: {
        ...
        value:{
          blocks: [
            GovUKBody({
              ...
              visibleWhen: Answer(Question.offence_analysis_offence_elements).match(Condition.Array.Contains(Option.addictions_perceived_needs)),
            }),
            GovUKBody({
              text: contentFor('question.offence_analysis_motivations.option.PRESSURISED_LED_BY_OTHERS'),
              visibleWhen: Answer(Question.offence_analysis_offence_elements).match(Condition.Array.Contains(Option.pressurised_led_by_others)),
            }),
            GovUKBody({
              text: contentFor('question.offence_analysis_motivations.option.EMOTIONAL_STATE_CHRISTY'),
              visibleWhen: Answer(Question.offence_analysis_offence_elements).match(Condition.Array.Contains(Option.emotional_state_christy)),
            }),
            GovUKBody({
              text: contentFor('question.offence_analysis_motivations.option.FINANCIAL_MOTIVATION'),
              visibleWhen: Answer(Question.offence_analysis_motivations).match(Condition.Array.Contains(Option.financial_motivation)),
            }),
            GovUKBody({
              text: contentFor('question.offence_analysis_motivations.option.HATRED_IDENTIFIABLE_GROUPS'),
              visibleWhen: Answer(Question.offence_analysis_motivations).match(Condition.Array.Contains(Option.hatred_identifiable_groups)),
            }),
            GovUKBody({
              text: contentFor('question.offence_analysis_motivations.option.SEEKING_EXERTING_POWER'),
              visibleWhen: Answer(Question.offence_analysis_motivations).match(Condition.Array.Contains(Option.seeking_exerting_power)),
            }),
            GovUKBody({
              text: contentFor('question.offence_analysis_motivations.option.SEXUAL_MOTIVATION'),
              visibleWhen: Answer(Question.offence_analysis_motivations).match(Condition.Array.Contains(Option.sexual_motivation)),
            }),
            GovUKBody({
              text: contentFor('question.offence_analysis_motivations.option.THRILL_SEEKING'),
              visibleWhen: Answer(Question.offence_analysis_motivations).match(Condition.Array.Contains(Option.thrill_seeking)),
            }),
            GovUKBody({
              text: commonContentFor('option.OTHER'),
              visibleWhen: Answer(Question.offence_analysis_motivations).match(Condition.Array.Contains(CommonOption.other)),
            }),
            GovUKBody({
              text: Answer('offence_analysis_motivations_other_details'),
              size: 's',
            }),
          ]
        },
        ...
        value:{
          blocks: [
            GovUKBody({
              ...
              visibleWhen: Answer(Question.offence_analysis_commited_against).match(Condition.Array.Contains(Option.one_or_more_people)),
            }),
            GovUKBody({
              text: commonContentFor('option.OTHER'),
              visibleWhen: Answer(Question.offence_analysis_commited_against).match(Condition.Array.Contains(CommonOption.other)),
            }),
            GovUKBody({
      ...
      },
      {
        ...
        value:{
          blocks: [
            ...
            GovUKBody({
              text: Answer(Question.offence_analysis_perpetrator_of_domestic_abuse_type_family_member_and_partner_details),
              size: 's',
            }),
          ]
        },
