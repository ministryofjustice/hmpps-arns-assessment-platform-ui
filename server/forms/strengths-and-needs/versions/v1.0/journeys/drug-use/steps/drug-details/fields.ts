...
export const drugIntakeFrequencyDetails = (drugValue: ChainableExpr<PipelineExpr>) =>
  GovUKCharacterCount({
        ...
        collection: Data('drugsUsedInLastSix').each(
          Iterator.Map(
            TemplateWrapper({
              ...
              slots: {
                fields: [drugIntakeFrequency(drugValueLower), drugIntakeFrequencyDetails(drugValueLower)],
              },
            }),
          ),
        ),
...
export const drugInjectedLastString = (drugValue: string) =>
  GovUKCheckboxInput({
    ...
    visibleWhen: Answer(drugLastUsedField(drugValue.toLowerCase()))
      .match(Condition.Equals(Option.last_six)),
    validWhen: [
      validation({
...
export const drugInjectedLast = (drugValue: ChainableExpr<PipelineExpr>) =>
  GovUKCheckboxInput({
    ...
    visibleWhen: Answer(drugLastUsedField(drugValue))
      .match(Condition.Equals(Option.last_six)),
    validWhen: [
      validation({
        condition: Self().match(Condition.IsRequired()),
...
export const injectedDrugsField = GovUKCheckboxInput({
  ...
  items: [
    ...
    {
      value: Option.cocaine,
      text: contentFor('option.COCAINE'),
    ...
    },
    {
      ...
      text: Answer(Question.other_drug_name),
      block: drugInjectedLastString(Option.amphetamines),
      visibleWhen: Answer(Question.select_misused_drugs)
