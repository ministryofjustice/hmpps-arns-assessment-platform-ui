...
export const pageContent = HtmlBlock({
  content: `
    ...
    <p class="govuk-body">This statement was prepared on 1 April 2026. It was last reviewed on 30 June 2026.</p>
    <p class="govuk-body">This website was last tested on 24 June 2026 against the WCAG 2.2 AA standard.</p>
    <p class="govuk-body">This was a spot check following a full accessibility audit on 25 March 2026.</p>
    <p class="govuk-body">The tests were carried out by User Vision.</p>
