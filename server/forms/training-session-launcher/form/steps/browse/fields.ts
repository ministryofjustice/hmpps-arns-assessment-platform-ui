    ...
    slots: {
      ...
      linkButtons: [
        GovUKLinkButton({
          ...
          href: Format('/forms/training-session-launcher/customise?scenario=%1', Item().path('id')),
        ...
        GovUKLinkButton({
          ...
          href: Format('/forms/training-session-launcher/browse?scenario=%1', Item().path('id')),
          attributes: { tabindex: '0' },
        }),
      ],
    },
