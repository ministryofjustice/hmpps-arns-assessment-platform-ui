...
describe('plan header', () => {
  ...
  it('renders the data used by repeated print page headers', () => {
    ...
    expect(html).toContain('data-print-crn="X000000"')
    expect(html).toContain('data-print-pnc="00/1000000X"')
    expect(html).toContain('data-print-date-of-birth="1 January 1990"')
