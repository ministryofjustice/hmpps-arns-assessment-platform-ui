...
├── integration_tests/      # Cypress E2E tests
...
make e2e                    # Run end-to-end tests using the Cypress interactive app
make e2e-headless           # Run end-to-end tests using the Cypress CLI
```
